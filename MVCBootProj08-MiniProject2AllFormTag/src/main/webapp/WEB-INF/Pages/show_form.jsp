<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<frm:form  modelAttribute="stud" enctype="multipart/form-data">
		<table align="center" bgcolor="pink" >
			...
			<tr>
				<td> student Name :</td>
				<td><frm:input path="sname" type="text"/>*<frm:errors path="sname"/></td>
			</tr>
			<tr>
				<td>Email :</td>
...
<%-- 				<td><frm:input path="pwd" type="password" /></td> --%>
				<td><frm:password path="pwd"/>*<frm:errors path="pwd"/></td>
			</tr>
			<tr>
				<td>Marries :</td>
			...
			<tr>
				...
				<td>
				<frm:checkboxes items="${hobiesInfo }" path="hobbies"/>*<frm:errors path="hobbies"/>
				</td>
			</tr>
			<tr>
				<td>Gender :</td>
			...
			<tr>
				...
				</frm:select>*<frm:errors path="lang"/></td>
			</tr>
			<tr>
				<td>notes :</td>
